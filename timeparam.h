...
private:
	...
	vector<double> refl_vdistances = {25,30,35,40,50,60,80,100,120,140,160,180,200};
	vector<vector<double>> cut_off_bins = { {219.655,228.234,231.098,240.577,250.347,263.198,282.257,291.907,298.098,316.456,323.92,320.731,318.492},
							{229.886,236.776,244.253,251.051,263.996,273.519,289.398,306.682,317.578,326.666,329.486,334.357,325.35},
							{245.582,255.652,261.169,265.991,276.691,289.391,305.449,320.593,327.463,340.855,333.567,341.88,334.271},
							{260.309,273.402,264.014,275.723,288.921,294.379,281.981,340.58,350,350,350,350,350},		// last 5 bins have no data (set to 350ns)
						};
	vector<vector<double>> tau_bins = { {10.215,7.92,7.19,8.445,5.26522,4.30833,3.12,2.37778,1.8037,1.29667,0.75625,0.3,0.0222222},
							{10.5204,11.4964,11.6321,8.70526,6.6,4.9,3.59692,2.66286,2.02394,1.5,0.923288,0.385897,0.0405063},
							{12.8796,12.2241,11.8407,11.0685,9.0902,6.18367,4.22889,2.98158,2.22895,1.56667,1.0129,0.5,0.0238095},
							{13.85,13.4286,13.7833,14.62,13.25,6.65,4.2,3.1,2.22895,1.56667,1.0129,0.5,0.0238095} 	// last 5 bins have no data (set same as [20,30] data)
						};
